...
for i in range(int(bodies_number)):
    ...
    print("{} {} {} {} 0 0 0".format(
        random.randint(200, 1000) * pow(-1, random.randint(0, 1)),                 # x
        random.randint(200, 1000) * pow(-1, random.randint(0, 1)),                 # y
        random.randint(200, 1000) * pow(-1, random.randint(0, 1)),                 # z
