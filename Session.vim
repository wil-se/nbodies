...
nnoremap ,r :e
vnoremap ," `<i"`>i"
nnoremap ,c m1I# `12<Right>
nnoremap ,u m1^xx`12<Left>
nnoremap ,cp :execute "normal! cprevious"
nnoremap ,cn :execute "normal! cnext"
nnoremap ,n :bnext
nnoremap ,d :bd
nnoremap ,sv :source $MYVIMRC
nnoremap ,rc :vsplit ~/.vimrc
nnoremap - ddp
nnoremap / :/\v
nnoremap H :cprevious
nnoremap L :cnext 
nnoremap _ ddkP
...
inoremap jk `^
iabbr __main if __name__ == "__main__":
iabbr __init def __init__(self,):<Left><Left>
iabbr pri print()<Left>
iabbr iff if:<Left>
let &cpo=s:cpo_save
unlet s:cpo_save
set autoread
...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/bundle/YouCompleteMe,~/.vim/bundle/Vundle.vim,~/.vim/bundle/emmet-vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-pandoc,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/YouCompleteMe/after,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/emmet-vim/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/vim-pandoc/after
set shortmess=filnxtToOSc
set statusline=%F\ -\ FileType-\ %y\ -\ L:\ %l\ /\ %L\ --\ %m
...
wincmd w
argglobal
if bufexists("cuda-barneshut.h") | buffer cuda-barneshut.h | else | edit cuda-barneshut.h | endif
balt main.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists("cuda-barneshut.cu") | buffer cuda-barneshut.cu | else | edit cuda-barneshut.cu | endif
balt cuda-barneshut.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 63 - ((1 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 63
...
wincmd w
argglobal
if bufexists("go.sh") | buffer go.sh | else | edit go.sh | endif
balt Makefile
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
tabnext 1
set stal=1
badd +1 cuda-barneshut.cu
badd +9 main.cpp
badd +12 ~/Scrivania/nbodies_w/render.h
badd +248 render.cpp
badd +5 cuda-barneshut.h
badd +0 common.cpp
badd +128 ~/.vimrc
badd +0 go.sh
badd +0 generator.py
badd +7 ~/Scrivania/cuda/reduction.cu
badd +0 Makefile
badd +11 input
